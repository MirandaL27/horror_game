...
map.addNode({ name: "bedroom_east_wall_test.jpg", north: -1, south: -1, east: 1, west: 3 , items: [{name: "test", fileName: "test.jpg",pos: {x: 0, y: 0},scale: 40,zIndex: 1, isHidden: false}]});
